...
export default () => {
    ...
    return <Stack spacing={0} pt={100}>
        <Stack spacing={50} p={matches ? 50 : 0} pb={0} align='center'>
            ...
            <Grid align='center' gutter={0} sx={{backgroundColor: '#BAD532'}}>
                ...
                <Grid.Col span={matches ? 6 : 12} sx={{overflow: 'hidden', position: matches ? 'relative' : 'initial', top: 30, left: 30}}>
            ...
            <Grid align='center' gutter={0} sx={{backgroundColor: '#1c1c1c', maxWidth: matches ? '90%' : '100%'}}>
                ...
                <Grid.Col span={matches ? 5 : 12} sx={{overflow: 'hidden', position: matches ? 'relative' : 'initial', left: 100}}>
                    <ZoomImage url='/img/background_6.jpeg'/>
                </Grid.Col>
            </Grid>
            <Grid gutter={50} sx={{maxWidth: matches ? '70%': '100%'}}>
                <Grid.Col span={matches ? 6 : 12}>
                    <Text color='dark.3' align='justify' size='xl' p={20}>
