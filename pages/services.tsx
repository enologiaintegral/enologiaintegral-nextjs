    ...
    return <Stack pt={100}>
        <Stack spacing={100} p={50} align='center'>
            ...
            <Grid align='center'>
                ...
                <Grid.Col span={6}>
                    <Stack>
                        <Title color='dark.3' weight={100}>Diseño, arte y digitalización de etiquetas</Title>
                        <Text>
                ...
                <Grid.Col span={6}>
                    <Image src='/img/equipo_tecnico.jpeg' height={250} fit='cover' styles={{root: {overflow: 'hidden'}, image: {bottom: 50, position: 'relative'}}}/>
                </Grid.Col>
                <Grid.Col span={6}>
                    <Stack>
